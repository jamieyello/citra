...
static void MapSharedMemory(Service::Interface* self) {
...
static void UnmapSharedMemory(Service::Interface* self) {
    u32* cmd_buff = Kernel::GetCommandBuffer();
...
const Interface::FunctionInfo FunctionTable[] = {
    {0x00010042, MapSharedMemory, "MapSharedMemory"},
    {0x00020000, UnmapSharedMemory, "UnmapSharedMemory"},
