...
const Interface::FunctionInfo FunctionTable[] = {
    ...
    {0x04090000, nullptr, "ResetAccelerometerCalibrationForSys"}, // UpdateConfigBlk00040003
    {0x040F0000, nullptr, "ResetParentalControlInfo"},
    {0x08010082, GetConfigInfoBlk8, "GetConfigForInit"},
    ...
    {0x08080000, nullptr, "UpdateDatabaseForInit"}, // UpdateConfigBlk1
